...
class MarkerModel {
    ...
    ///중심 좌표와 정해진 반경(Km) 내에 있는 마커목록을 반환합니다.
    static func getMarkers(centerCoordinates center: CLLocationCoordinate2D, radiusInKilometers radius: Double)-> Observable<[MarkerInfo]>{
